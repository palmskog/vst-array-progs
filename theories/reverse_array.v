...
Definition _len : ident := 58%positive.
...
(Ssequence
  ...
  (Ssequence
    ...
    (Sassign
      (Ederef
        (Ebinop Oadd (Etempvar _a (tptr tint)) (Etempvar _j tint)
          (tptr tint)) tint) (Etempvar _tmp tint))))
|}.

Definition f_reverse := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_a, (tptr tint)) :: (_len, tint) :: nil);
  fn_vars := nil;
    ...
    (Ssequence
      ...
      (Scall None
        (Evar _swap (Tfunction
                      ...
                      tvoid cc_default))
        ((Etempvar _a (tptr tint)) :: (Etempvar _i tint) ::
         (Ebinop Osub
...
((___builtin_ais_annot,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_swap, Gfun(Internal f_swap)) :: (_reverse, Gfun(Internal f_reverse)) ::
 (_four, Gvar v_four) :: (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _four :: _reverse :: _swap :: ___builtin_debug ::
